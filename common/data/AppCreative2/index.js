...
import availableThumb from '@/common/assets/image/appCreative/availableThumb.png';
...
export const bannerData = {
  news: 'NEWS',
  newsLabel: 'Gio can now make calls on your behalf',
  title: 'Meet Gio. Your new AI-powered Executive Assistant.',
  text: 'Gio integrates with all of your personal and professional accounts and can autonomously do any task on your behalf.',
  button: [
    {
      id: 1,
      title: 'Google Play',
...
export const whyChooseUs = [
  {
    ...
    text: `Add, delete, and move around events on your calendar.`,
  ...
  },
  {
    ...
    icon: icon2,
    title: 'Make calls',
    text: `Schedule appointments, make reservations, and cancel services.`,
  ...
  },
  {
    ...
    text: `Set reminders, due dates, and tasks.`,
  ...
  },
  {
    ...
    text: `Send emails and slacks on your behalf.`,
