...
const ButtonStyle = styled.button`
  ...
  padding-top: ${themeGet('space.2', '8')}px !important;
  padding-bottom: ${themeGet('space.2', '8')}px  !important;
  padding-left: ${themeGet('space.4', '15')}px  !important;
  padding-right: ${themeGet('space.4', '15')}px  !important;
  border: 0;
  transition: all 0.3s ease;
  span.btn-text {
    padding-left: ${themeGet('space.1', '4')}px  !important;
    padding-right: ${themeGet('space.1', '4')}px  !important;
  }
  span.btn-icon {
    display: flex;
    > div {
